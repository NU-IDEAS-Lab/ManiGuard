...
def build_scene_registry(
    ...
    registry: list[SentinelSceneSpec] = []
    ...
    if not registry:
        raise ValueError(f"No Sentinel scenes discovered under {benchmark_root}")
    return registry
