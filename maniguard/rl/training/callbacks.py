"""SB3 callbacks for maniguard RL."""
...
class ViewerVideoCallback(BaseCallback):
    ...
    def _grab_frame(self):
        ...
        # ``render_on_step=False`` on ManiGuardSB3VectorEnvironment means the
        ...
        # pattern as maniguard.task_generation.pipeline_common uses.
        og.sim.render()
...
class PeriodicEvalCallback(BaseCallback):
    ...
    def _on_rollout_end(self) -> None:
        ...
        from maniguard.rl.algorithms.eval import evaluate_policy
