...
object (``maniguard.rl.grasps`` pipeline) transfer directly.
"""
...
class PickAndLiftTask(GraspTask):
    ...
    def _load(self, env):
        ...
        if self._goal_region_spec is not None:
            ...
            if existing_marker is not None:
                ...
                from maniguard.utils.goal_region import spawn_goal_region_marker
    ...
    def _reset_agent(self, env):
        ...
        if self._grasp_resetter is None:
            from maniguard.rl.grasps.reset import GraspDatasetResetter
