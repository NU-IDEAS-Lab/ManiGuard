...
For each row of ``maniguard/task_generation/utils/franka_graspability.csv`` (or any
...
def _eye_lookat_to_quat(eye, lookat):
    ...
    Identical to ``maniguard.task_generation.utils.video.eye_lookat_to_quat``
...
def _render_one(env, primitives, category, model, args, obj_dir,
    ...
    try:
        ...
        from maniguard.rl.grasps.collector import run_grasp_attempt
...
def main():
    ...
    if args.with_surface:
        ...
        # Provisional spawn xyz (correct xy + maniguard z = support_top_z +
