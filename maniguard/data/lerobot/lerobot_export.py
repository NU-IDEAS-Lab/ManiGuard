...
Use ``/data/Projects/ManiGuard/.venv-lerobot-v2`` (already provisioned with
...
def main():
    ...
    p.add_argument("--repo-id", required=True,
                   help="LeRobot dataset identifier, e.g. maniguard/pnp_multitask")
    ...
    if args.push_to_hub:
        ...
        dataset.push_to_hub(
            tags=["panda", "omnigibson", "sim", "maniguard", "pnp"],
            license="apache-2.0",
