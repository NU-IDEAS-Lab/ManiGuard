...
with ``tools.cabinet_rerender_base --tasks task_NNNN`` (recomputes cameras/gate/LTL/surface + re-renders
...
Usage:
  python -m tools.cabinet_swap_object --task-dir <ABS>/task_0001/base --target box_of_yogurt/znhjgm
  python -m tools.cabinet_swap_object --task-dir <ABS>/task_0028/base --obstacle can/dhqrwr
  python -m tools.cabinet_swap_object --task-dir <ABS>/task_0012/base --target can_of_soda/bfrzvk --obstacle box_of_baking_powder/zevydc
"""
