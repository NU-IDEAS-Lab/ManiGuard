...
Generated by `sentinel.utils.task_spec.generate_ltl_safety_json` from the selected target and fragile synsets. The combined formula typically monitors:
...
`sentinel/task_generation/clutter_scene_pipeline.py`
