...
### `sentinel/task_generation/utils/stack_pipeline/`
...
### `sentinel/task_generation/utils/food_transfer_pipeline/`
...
### `sentinel/task_generation/utils/lid_transport_pipeline/`
...
python -m sentinel.task_generation.utils.stack_pipeline.scan_top_surface \
  --output scan_top_full.json --resume

# Then in dependency order:
python -m sentinel.task_generation.utils.food_transfer_pipeline.derive_container_openings
python -m sentinel.task_generation.utils.food_transfer_pipeline.build_transfer_compatibility
python -m sentinel.task_generation.utils.lid_transport_pipeline.build_lid_transport_food_compat
```
