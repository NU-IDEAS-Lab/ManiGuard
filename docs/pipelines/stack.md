...
Generated by `sentinel.utils.task_spec.generate_stack_ltl_safety_json` over the target and stack-item synsets. The combined formula monitors high-level stack safety:
...
`sentinel/task_generation/stack_scene_pipeline.py`
