...
::
    ...
    CUDA_VISIBLE_DEVICES=0 OMNIGIBSON_HEADLESS=1 \\
        python -m sentinel.task_generation.cabinet_pickup_pipeline \\
...
# sentinel patches must be imported before omnigibson.
...
from sentinel.task_generation.utils.placeable import list_eligible_surfaces
...
from sentinel.utils.task_spec import generate_cabinet_pickup_activity
...
_FOOTPRINTS_PATH = (
    _PROJECT_ROOT
    / "sentinel" / "task_generation" / "utils" / "object_footprints.json"
)
