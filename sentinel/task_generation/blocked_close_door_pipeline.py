...
Usage:
    python -m sentinel.task_generation.blocked_close_door_pipeline \
...
def run_dry_run(args):
    ...
    try:
        ...
        log.warning("blocked_close_door_pipeline dry-run: scene path lookup for %s failed: %s", args.scene_model, exc)
        pass
