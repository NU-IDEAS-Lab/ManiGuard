...
# SENTINEL-Lite repo root is 4 levels up from this file:
#   <repo>/sentinel/task_generation/utils/stack_pipeline/test_stack_self_stability.py
...
def _run_one_batch(batch_candidates, args, batch_idx):
    ...
    from sentinel.task_generation.pipeline_common import hide_walls_and_ceiling
