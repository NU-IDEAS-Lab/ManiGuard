...
Sources:
  * Targets   — sentinel/task_generation/utils/stack_pipeline/derived_top_features.json
  ...
  * Stack items — sentinel/task_generation/utils/stack_pipeline/stack_same_pool.json
