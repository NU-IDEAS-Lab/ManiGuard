...
Usage::
    ...
    python -m sentinel.task_generation.jar_transport_pipeline \\
...
from sentinel.task_generation.utils.jar_transport_pipeline.select import (
    JAR_MODELS,
    select_jar_and_item,
)
...
from sentinel.utils.task_spec import generate_jar_transport_activity
