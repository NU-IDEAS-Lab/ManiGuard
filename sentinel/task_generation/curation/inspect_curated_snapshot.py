...
def _inspect_loaded_snapshot(env, entry, snapshot_path: str, diagnostics_entry, support_name_override=None) -> dict[str, Any]:
    ...
    from sentinel.utils.surface_discovery import is_table_like
...
def main():
    ...
    from sentinel.task_generation.curation.curation_manifest import load_curation_manifest
    from sentinel.task_generation.pipeline_common import pipeline_exit
