...
Usage:
    python -m sentinel.eval.benchmark --config configs/eval/sim_table_25k.yaml
    python -m sentinel.eval.benchmark --config configs/eval/sim_table_25k.yaml --max-steps 500
"""
...
def config_from_cli() -> EvalConfig:
    ...
    p = argparse.ArgumentParser(description="Evaluate VLA on SENTINEL benchmark.")
