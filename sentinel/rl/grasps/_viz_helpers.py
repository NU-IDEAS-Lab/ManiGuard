...
Used by:
  - sentinel.rl.grasps.inspect_mesh         (point cloud only)
  - sentinel.rl.grasps.visualize_grasps      (grasps overlaid on cloud)
  - sentinel.rl.grasps.render_grasps         (per-object PNGs alongside
