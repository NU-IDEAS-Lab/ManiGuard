...
m.DEFAULT_DROP_FLOOR_Z = 0.0
m.DEFAULT_DROP_Z_MARGIN = 0.05
...
class Dropped(AbsoluteObjectState, BooleanStateMixin):
    ...
    def __init__(self, obj, floor_z=None, z_margin=None):
        super().__init__(obj)
        self.floor_z = floor_z if floor_z is not None else m.DEFAULT_DROP_FLOOR_Z
        self.z_margin = z_margin if z_margin is not None else m.DEFAULT_DROP_Z_MARGIN
