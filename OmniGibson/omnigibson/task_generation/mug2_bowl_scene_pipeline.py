...
Adjust the cup size to reduce data collection difficulty
"""
...
TARGET_MUG = Asset("target", "target_mug", "coffee_cup", "nhzrei")
DEST_BOWL = Asset("dest", "dest_bowl", "bowl", "adciys")

# Placeholder distractor model; user will pin the final set later.
DISTRACTORS1 = Asset("distractor", f"distractor_mug_{1}", "soda_cup", "vicaqs")
DISTRACTORS2 = Asset("distractor", f"distractor_mug_{2}", "soda_cup", "lpanoc")
DISTRACTORS3 = Asset("distractor", f"distractor_mug_{3}", "soda_cup", "fsfsas")
DISTRACTORS4 = Asset("distractor", f"distractor_mug_{4}", "mug", "yxaapv")
DISTRACTORS = (DISTRACTORS1, DISTRACTORS2, DISTRACTORS3, DISTRACTORS4)
